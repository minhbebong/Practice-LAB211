...
public class LoginTienPhong {
    ...
    public void checkCaptcha(ResourceBundle bundle) {
        ...
        while (true) {
            ...
            //Nếu yêu cầu captcha trùng hoàn toàn input thì dùng câu lệnh điều kiện này
//            if (input.equals(captcha)) return;
//            else System.out.println(bundle.getString("wrong.captcha"));
        }
    }
}
