...
public class Calculator {
     public void additionMatrix() {
        ...
        int row1 = checkInput.getMatrixSize("Enter Row Matrix 1:");
        int col1 = checkInput.getMatrixSize("Enter Column Matrix 1:");
        int[][] matrix1 = checkInput.getMatrixValue(row1, col1, 1);

        int row2 = 0, col2 = 0;
        while (true) {
            row2 = checkInput.getMatrixSize("Enter Row Matrix 2:");
            if (row2 != row1) {
        ...
        while (true) {
            col2 = checkInput.getMatrixSize("Enter Column Matrix 2:");
        ...
        int[][] matrix2 = checkInput.getMatrixValue(row2, col2, 2);
