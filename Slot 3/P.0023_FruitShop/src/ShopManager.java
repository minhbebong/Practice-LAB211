...
public class ShopManager {
    ...
    public void createFruit(ArrayList<Fruit> fruitList) {
        ...
        while (true) {
            ...
            String fruitName = checkInput.getString("Enter fruit name: ", "Invalid name", 
                    "^[a-zA-Z ]+$");
            int price = checkInput.getInt("Enter fruit price: ", "Invalid price number", 
                    0, Integer.MAX_VALUE);
            int quantity = checkInput.getInt("Enter quantity: ", "Invalid quantity", 
                    1, Integer.MAX_VALUE);
            String origin = checkInput.getString("Enter fruit origin: ", "Invalid origin", 
                    "^[a-zA-Z ]+$");
            ...
            String choice = checkInput.getString("Do you want to continue? (Y/N)",
    ...
    public void shopping(ArrayList<Fruit> fruitList, Hashtable<Integer, Order> orderTable) {
        ...
        while (true) {
            ...
            int id = checkInput.getInt("Select id of item: ", "Id out of range", 1, 4);
            ...
            int boughtQuantity = checkInput.getInt("Enter quantity you want to buy: ",
                    "Sorry, we only have " + fruit.getQuantity() + " fruits left", 1, fruit.getQuantity());
            String choice = checkInput.getString("Do you want to order now? (Y/N)", 
                    "Only answer yes or no", "^(y|Y|n|N)$");
        ...
        String customerName = checkInput.getString("Enter your name: ", "Invalid name", "^[a-zA-Z ]+$");
